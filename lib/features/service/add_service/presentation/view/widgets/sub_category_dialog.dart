...
class SubCategoryDialog extends StatefulWidget{
  final Function(SubCategoryResult subCategory) onSubCategorySelected;
  const SubCategoryDialog({super.key,required this.onSubCategorySelected});
      ...
      content: SizedBox(
        ...
        child: BlocBuilder<AddServiceCubit, AddServiceState>(
          builder: (context, state) {
            if (state is GetSubCategoriesLoading) {
            ...
            } else if (state is GetSubCategoriesError) {
              return Center(
                child: Column(
              ...
              final cat =context.read<AddServiceCubit>().subCategories;
              if (cat.isEmpty) {
                return Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Image.asset("assets/images/bullet-points_15202248.png",width: 32.w,height: 32.h,),
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    leading: Image.asset("assets/images/bullet-points_15202248.png",width: 24.w,height: 24.h,),
                    title: Text(categoryItem.name ?? "No Name",
                        style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w500)),
                    onTap: () {
                      widget.onSubCategorySelected(categoryItem);
